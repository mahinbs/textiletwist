...
import { LayoutDashboard, Package, ShoppingBag, Users, X, Settings, BarChart3, MessageSquare, FolderTree, Bell } from 'lucide-react';
...
const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside className={`
                fixed top-0 left-0 bottom-0 z-50 w-64 bg-primary text-white transition-transform duration-300 ease-in-out flex flex-col
